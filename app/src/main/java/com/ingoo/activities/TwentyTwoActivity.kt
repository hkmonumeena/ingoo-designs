...
class TwentyTwoActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val view = layoutInflater.inflate(R.layout.activity_twenty_two, null)
        ...
        constraintLayoutHeader.setOnClickListener {  startActivity(Intent(this,TwentyThreeActivity::class.java)) }
    }
}