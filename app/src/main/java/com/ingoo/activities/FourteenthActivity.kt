...
class FourteenthActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val view = layoutInflater.inflate(R.layout.activity_fourteenth, null)
        ...
        constraintLayoutHeader.setOnClickListener { startActivity(Intent(this,SixteenthActivity::class.java))  }
    }
}