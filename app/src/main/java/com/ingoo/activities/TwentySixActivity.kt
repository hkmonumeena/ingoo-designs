...
class TwentySixActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        constraintLayoutHeader.setOnClickListener { startActivity(Intent(this,TwentySeventhActivity::class.java)) }
    }
