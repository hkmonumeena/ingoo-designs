...
class TwentyOneActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val view = layoutInflater.inflate(R.layout.activity_twenty_one, null)
        ...
        constraintLayoutHeader.setOnClickListener { startActivity(Intent(this,TwentyTwoActivity::class.java)) }
    }
}