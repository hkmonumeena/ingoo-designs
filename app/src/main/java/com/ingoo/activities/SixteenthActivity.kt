...
import com.ingoo.R
import kotlinx.android.synthetic.main.activity_sixteenth.*
...
class SixteenthActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val view = layoutInflater.inflate(R.layout.activity_sixteenth, null)
        ...
        rlHeader.setOnClickListener { startActivity(Intent(this,SeventeethActivity::class.java)) }
    }
}