...
class TwentyFourActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        constraintLayoutHeader.setOnClickListener { startActivity(Intent(this,TwentyFiveActivity::class.java)) }
    }
}