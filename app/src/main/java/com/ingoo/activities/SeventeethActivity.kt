...
class SeventeethActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rlHeader.setOnClickListener { startActivity(Intent(this,EighteenthActivity::class.java)) }
    }
}