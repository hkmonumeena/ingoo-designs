...
class TenthActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val view = layoutInflater.inflate(R.layout.activity_tenth, null)
        ...
        rlHeader.setOnClickListener { startActivity(Intent(this,EleventhActivity::class.java)) }
        rlItems.setOnClickListener { startActivity(Intent(this,EleventhActivity::class.java)) }
    }
}